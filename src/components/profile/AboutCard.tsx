...
import { DEVELOPER_NAME, DEVELOPER_BIO, SUPPORT_URL, APP_VERSION } from '../../constants/about';
  ...
  return (
    <View style={[styles.card, { backgroundColor: Colors.bg1, borderColor: Colors.border }]}>
      ...
      <View style={styles.devRow}>
        ...
        <Text style={[styles.devName, { color: Colors.textSecondary }]}>{DEVELOPER_NAME}</Text>
      </View>
