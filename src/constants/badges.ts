...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  ...
  { id: 'streak_21',  category: 'streak', label: 'Habit Forged',     description: '21-day streak — the habit is real', icon: 'body',            threshold: 21 },
  ...
  // Cycle badges (milestones)
  { id: 'cycle_1', category: 'cycle', label: 'First Finish',    description: 'Complete a milestone goal',           icon: 'checkmark-done', threshold: 1 },
  { id: 'cycle_3', category: 'cycle', label: 'Hat Trick',       description: 'Complete 3 cycles of a milestone',   icon: 'repeat',         threshold: 3 },
  { id: 'cycle_5', category: 'cycle', label: 'Serial Achiever', description: 'Complete 5 cycles of a milestone',   icon: 'rocket',         threshold: 5 },
  ...
  { id: 'level_10', category: 'level', label: 'Achiever',     description: 'Reach Level 10', icon: 'flash',           threshold: 10 },
